    ...
    start: function(params, next) {
        ...
        for (category of params['categories']) {
            responseBtns[category].btn.bind('click tap', function () {
                ...
                if (acc == true) {
                    feedbackTxt.text = 'Yes! You got it. This is a member of category '.concat(params['btnLabels'][correctCategory])
                } else {
                    feedbackTxt.text = 'Sorry, that\'s not it. This is '.concat(params['btnLabels'][correctCategory])
                }
