var typicality = {
    ...
    initElements: function (params) {
        ...
        instructionsTxt = space.display.text({
            ...
            align: "center",
            font: "bold 25px sans-serif",
            text:  "How typical is this item of its category\n(i.e., how well does it represent your sense of the category?)", //"How typical is this item as a member of its category?",
            fill: "rgba(0,0,0,1)",
            zIndex: "front",
        })
