...
for index, i in enumerate(dataA):
    generate_square(i[0], i[1], 'discourage_A/discourage_A' + str(index) + '.png')

for index, i in enumerate(dataB):
    generate_square(i[0], i[1], 'discourage_B/discourage_B' + str(index) + '.png')

for index, i in enumerate(dataW):
    generate_square(i[0], i[1], 'discourage_W/discourage_W' + str(index) + '.png')

for index, i in enumerate(dataX):
    generate_square(i[0], i[1], 'discourage_X/discourage_X' + str(index) + '.png')

for index, i in enumerate(dataY):
    generate_square(i[0], i[1], 'discourage_Y/discourage_Y' + str(index) + '.png')

for index, i in enumerate(dataZ):
    generate_square(i[0], i[1], 'discourage_Z/discourage_Z' + str(index) + '.png')
...
plt.title("discourage extrapolation condition")
plt.savefig('structure_discourage.png')
