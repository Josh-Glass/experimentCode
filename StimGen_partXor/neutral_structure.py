...
for index, i in enumerate(dataA):
    generate_square(i[0], i[1], 'neutral_A/neutral_A' + str(index) + '.png')

for index, i in enumerate(dataB):
    generate_square(i[0], i[1], 'neutral_B/neutral_B' + str(index) + '.png')

for index, i in enumerate(dataW):
    generate_square(i[0], i[1], 'neutral_W/neutral_W' + str(index) + '.png')

for index, i in enumerate(dataX):
    generate_square(i[0], i[1], 'neutral_X/neutral_X' + str(index) + '.png')

for index, i in enumerate(dataY):
    generate_square(i[0], i[1], 'neutral_Y/neutral_Y' + str(index) + '.png')

for index, i in enumerate(dataZ):
    generate_square(i[0], i[1], 'neutral_Z/neutral_Z' + str(index) + '.png')
...
plt.savefig('structure_neutral.png')
